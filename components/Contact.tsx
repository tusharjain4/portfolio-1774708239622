          ...
          <div className="glass-effect p-8 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <a
                ...
                className="p-6 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300 card-hover"
              >
                ...
                <p className="text-purple-400">{portfolioData.contact.email}</p>
              </a>
              ...
              >
                ...
                <p className="text-purple-400">Connect with me</p>
              </a>
              ...
              >
                ...
                <p className="text-purple-400">View my code</p>
              </a>
            </div>
          </div>
        </div>
